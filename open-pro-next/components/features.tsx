        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              Go from idea to live app without guessing
            </h2>
            <p className="text-lg text-indigo-200/65">
              Pick a template, verify once, and let AI build the first draft for
              your office, barbershop, or service business.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                Pick Free Trial or a plan and click Start. No card for the
                trial.
              </p>
            </article>
            <article>
              ...
              <p className="text-indigo-200/65">
                One email code unlocks the builder and AI suggestions.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                You’re inside the builder on step 3—edit pages, forms, and
                automations, then publish.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                One toggle for EN / ES — no mixed content, no manual rewrites.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Built-in scheduling, reminders, and checkout so you can charge
                on day one.
              </p>
            </article>
            <article>
              ...
              <p className="text-indigo-200/65">
                Connect your domain and ship with automatic SSL — no extra setup
                screens.
              </p>
            </article>
          </div>
