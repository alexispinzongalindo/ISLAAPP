        ...
        {templates.map((t) => (
          ...
          >
            ...
            <div className="flex gap-3">
              {(t.slug === "bookflow" || t.slug === "medtrack" || t.slug === "fitcoach" || t.slug === "restaurant" || t.slug === "spa" || t.slug === "clinic" || t.slug === "dental" || t.slug === "law" || t.slug === "real-estate" || t.slug === "habits" || t.slug === "priorityos" || t.slug === "flexspace") && (
                <a
                  href={`/live/${t.slug}`}
