...
export const templates: TemplateDefinition[] = [
{
  ...
  desc: "Functional booking app for service teams: choose services, assign providers, book time slots, and confirm appointments with a clean customer flow.",
  descEs: "Aplicacion funcional de reservas para equipos de servicio: seleccionar servicios, asignar proveedores, reservar horarios y confirmar citas en un flujo claro.",
  thumb: bookflowThumb,
  hero: bookflowThumb,
},
{
...
{
  slug: "learnflow",
  title: "LearnFlow (Online Courses)",
  titleEs: "LearnFlow (Cursos Online)",
  tags: ["Video Courses", "Quizzes", "Certificates"],
  desc: "Create courses, upload lessons with video links, run quizzes, track student progress, and issue certificates with event logs.",
  descEs: "Crea cursos, publica lecciones con video, ejecuta quizzes, monitorea progreso y emite certificados con registro de eventos.",
  thumb: postThumb15,
  hero: postThumb15,
},
{
